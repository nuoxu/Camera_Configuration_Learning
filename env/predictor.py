...
class COCODemo(object):
    ...
    def compute_state(self, image):
        ...
        with torch.no_grad():
            features, locations, box_cls, box_regression, centerness, image_sizes = self.model.compute_heatmap(image_list)
        return features, locations, box_cls, box_regression, centerness, image_sizes

    def compute_bbox_from_state(self, image, features, locations, box_cls, box_regression, centerness, image_sizes):
        with torch.no_grad():
            predictions = self.model.post_processing(features, locations, box_cls, box_regression, centerness, image_sizes)
    ...
    def visualize_bbox(self, image, top_predictions):
