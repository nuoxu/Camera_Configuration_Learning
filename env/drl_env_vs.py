...
class ViewScaleSearchEnv(gym.Env):
    metadata = {
    ...
    def set_position_by_action(self, action):
        ...
        self.current_image_name = self.current_image_name[:3] + str(c_lon) + str(c_lat) + str(c_sca) + self.current_image_name[-1:]
    ...
    def set_position_by_action_greedy(self, action):
        ...
        current_image_name = self.current_image_name[:3] + str(c_lon) + str(c_lat) + str(c_sca) + self.current_image_name[-1:]
